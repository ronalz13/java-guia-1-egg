...
public class ejercicio7 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(" ingrese el tipo de motor numerado del 1 al 4");
        ...
        switch (opcion) {
            case 1:
                ...
                break;            
            case 2:
                System.out.println("la bomba es una boba de gasolina");
                break;
            case 3:
                System.out.println("la bomba es una bomba de hormigon");
                break;
            case 4:
                System.out.println("la bomba es una boba de pasta alimenticia");
                break;
            default:
